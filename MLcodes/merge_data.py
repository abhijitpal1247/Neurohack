...
df_data1 = pd.read_excel(os.join(folder,'Data_1.xlsx'))
df_data2 = pd.read_excel(os.join(folder,'Data_2.xlsx'),sheet_name=1)
#%%
# %% concatenate columns
...
#%%
df_combined.to_csv(os.join(folder,'data_combined.csv'),index=False)
# %%
